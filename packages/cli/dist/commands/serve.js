...
const local_api_1 = require("@javascriptnotebook/local-api");
exports.serveCommand = new commander_1.Command()
    ...
    try {
        ...
        // user instructions
        console.log(`Opened ${filename}. Now navigate to http://localhost:${options.port} to edit your coding notebook.`);
    }
    catch (err) {
        // check for errors
